...
class SimpleCalendar:
    async def start_calendar(
        ...
        inline_kb.insert(
            InlineKeyboardButton(
                f"{MESSAGES_MONTH[month]} {str(year)}", callback_data=ignore_callback
            )
        )
        inline_kb.insert(
            InlineKeyboardButton(
        ...
        for week in month_calendar:
            ...
            for day in week:
                ...
                inline_kb.insert(
                    InlineKeyboardButton(
                        str(day),
                        callback_data=calendar_callback.new("ДЕНЬ", year, month, day),
                    )
                )
        ...
        inline_kb.insert(
            InlineKeyboardButton(
                "МЕСЯЦ <",
                callback_data=calendar_callback.new("ПРЕД-МЕСЯЦ", year, month, day),
            )
        )
        inline_kb.insert(
            InlineKeyboardButton(
                f"{MESSAGES_MONTH[month]}", callback_data=ignore_callback
            )
        )
        inline_kb.insert(
            InlineKeyboardButton(
                "> МЕСЯЦ",
                callback_data=calendar_callback.new("СЛЕД-МЕСЯЦ", year, month, day),
            )
        )
